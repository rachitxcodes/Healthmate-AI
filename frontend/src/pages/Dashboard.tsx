                    ...
                    <div className="space-y-3">
                      {upcomingMedicines.length === 0 ? (
                        ...
                        upcomingMedicines.slice(0, 3).map((med, idx) => {
                          ...
                          return (
                            <div key={idx} className={`flex items-center justify-between p-3 rounded-xl border transition-all ${isTaken
                              ...
                              <div className="flex items-center gap-3.5 min-w-0">
                                <div className={`w-9 h-9 rounded-lg flex items-center justify-center shrink-0 ${isTaken
                              ...
                              <button
                                ...
                                className={`w-8 h-8 rounded-full border flex items-center justify-center transition-all shrink-0 ${isTaken

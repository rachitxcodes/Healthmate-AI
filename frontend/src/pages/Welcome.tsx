...
import previewImg from "../assets/health_dashboard_preview.png";
...
export default function Welcome() {
  ...
  return (
    <div className="min-h-screen text-slate-900 overflow-x-hidden relative z-0">
      ...
      <main className="relative mx-auto max-w-4xl px-6 pt-32 sm:pt-36 lg:pt-40 pb-20 z-10">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <motion.p
            ...
            className="mt-6 max-w-2xl text-slate-600 text-[16px] sm:text-[18px] leading-relaxed font-semibold drop-shadow-sm"
          >
            ...
            {!loading && (
              user ? (
                <motion.button
                  ...
                  className="px-10 py-3.5 rounded-[1.25rem] font-bold text-white bg-slate-900 hover:bg-black shadow-[0_8px_20px_rgba(0,0,0,0.15)] hover:-translate-y-0.5 transition-all outline-none flex items-center justify-center text-[16px] border border-slate-800"
                ...
                <>
                  ...
                  <Link to="/signup" className="flex">
                    <motion.button
                      whileTap={{ scale: 0.96 }}
                      className="px-8 py-3.5 rounded-[1.25rem] font-bold text-slate-900 bg-white border-2 border-slate-200 shadow-sm hover:bg-slate-50 hover:border-slate-300 hover:shadow-[0_8px_20px_rgba(0,0,0,0.06)] hover:-translate-y-0.5 transition-all text-[16px] flex items-center justify-center"
                      style={{ minHeight: '56px' }}
                    >
                      Create an account
                    </motion.button>
